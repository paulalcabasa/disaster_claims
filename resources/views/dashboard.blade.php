...
<head>
	...
	<title>Disaster Claims Monitoring</title>
			...
			<div class="sidebar-content">
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<!-- Main -->
						<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">REPAIR</div> <i class="icon-menu" title="Main"></i></li>
					<!-- 	<li class="nav-item">
						...
						<li class="nav-item">
							<a href="{{ route('entry') }}" class="nav-link">
